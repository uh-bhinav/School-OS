...
async def test_create_conversation_and_send_messages(
    ...
    response = await test_client.post("/api/v1/comms/conversations/", json=create_convo_payload)
    ...
    response = await test_client.post(
        f"/api/v1/comms/conversations/{conversation_id}/messages/",
    ...
    app.dependency_overrides[get_current_user_profile] = lambda: mock_parent_profile
    response = await test_client.get(f"/api/v1/comms/conversations/{conversation_id}/messages/")
