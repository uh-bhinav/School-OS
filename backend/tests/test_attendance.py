...
async def test_create_single_attendance_record_as_teacher(
    ...
    period_response = await test_client.post("/v1/periods/", json=period_payload)
    ...
    response = await test_client.post("/v1/attendance/", json=attendance_payload)
...
async def test_create_bulk_attendance_records_as_teacher(
    ...
    response = await test_client.post("/v1/attendance/bulk", json=bulk_payload)
...
async def test_get_attendance_records_by_date_range(
    ...
    for record_date in dates_to_create:
        ...
        await test_client.post("/v1/attendance/", json=payload)
