...
from app.schemas.student_fee_assignment_schema import (
...
@router.post(
    "/overrides",
    response_model=StudentFeeAssignmentOut,
    status_code=200,
...
async def set_student_fee_override(
    ...
    return service.create_or_update_override(
        override_data=override_in,
