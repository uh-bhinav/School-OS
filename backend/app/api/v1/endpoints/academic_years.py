...
async def create_new_academic_year(*, db: AsyncSession = Depends(get_db), year_in: AcademicYearCreate):
...
async def set_the_active_year(school_id: int, academic_year_id: int, db: AsyncSession = Depends(get_db)):
    """
