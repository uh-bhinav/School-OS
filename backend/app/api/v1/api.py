...
from app.api.v1.endpoints import (
    ...
    timetable_proxy,  # Proxy to standalone Timetable Generator service
...
# Timetable Generator Proxy (routes to standalone OR-Tools solver service)
api_router.include_router(
    timetable_proxy.router,
    prefix="/admin/timetable",
    tags=["Timetable Generator (OR-Tools Solver)"],
)
