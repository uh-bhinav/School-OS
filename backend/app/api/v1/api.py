...
from app.api.v1.endpoints import (
    ...
    discounts,
    employment_statuses,
    exam_periods,  # <-- NEW: Exam period scheduling
    exam_types,
    exams,
    fee_structure,
    fee_templates,
...
api_router.include_router(
    dashboard.router, prefix="", tags=["Dashboard"]
)  # Dashboard endpoints
api_router.include_router(
...
api_router.include_router(
    student_contacts.router, prefix="/student-contacts", tags=["Students"]
)

# Academics
api_router.include_router(exams.router, prefix="/exams", tags=["Exams"])
api_router.include_router(exam_types.router, prefix="/exam-types", tags=["Exams"])
api_router.include_router(exam_periods.router, prefix="/exam-periods", tags=["Exam Periods"])  # <-- NEW
api_router.include_router(marks.router, prefix="/marks", tags=["Marks"])
api_router.include_router(
    report_cards.router, prefix="/report-card", tags=["Report Cards"]
)  # <-- 2. ADDED THIS LINE
api_router.include_router(
...
# E-commerce
api_router.include_router(
    products.router, prefix="/products", tags=["E-Commerce: Products"]
)
api_router.include_router(
...
# Staff
api_router.include_router(
    employment_statuses.router, prefix="/employment-statuses", tags=["Staff"]
)
...
api_router.include_router(
    fee_structure.router, prefix="/finance", tags=["Finance - Structure"]
)
api_router.include_router(
    fee_templates.router, prefix="/finance/templates", tags=["Finance - Templates"]
)
api_router.include_router(
    discounts.router, prefix="/finance", tags=["Finance - Discounts"]
)
api_router.include_router(
    invoices.router, prefix="/finance", tags=["Finance - Invoices & Payments"]
)
api_router.include_router(
    student_fee_assignments.router, prefix="/finance", tags=["Finance - Overrides"]
)
api_router.include_router(
    refunds.router, prefix="/finance/refunds", tags=["Finance - Refunds"]
)
api_router.include_router(
...
api_router.include_router(
    payments.router, prefix="/finance/payments", tags=["Finance - Payments"]
)
...
api_router.include_router(
    leaderboards.router, prefix="/leaderboard", tags=["Leaderboards"]
)
