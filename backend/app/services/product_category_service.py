...
async def create_product_category(db: AsyncSession, *, category_in: ProductCategoryCreate) -> ProductCategory:
...
async def get_all_product_categories_for_school(db: AsyncSession, school_id: int) -> list[ProductCategory]:  # Changed from List to list
