...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "identity": {
        ...
        "display_name": "School",
        "subdomain": None,
        "external_ids": {"emis": None, "legacy": None},
    },
    "branding": {
        "logo": {
            "primary_url": "https://placehold.co/200x80/2563eb/white?text=School",
            "dark_mode_variant_url": None,
        },
        "colors": {
            "primary": "#2563eb",
    ...
    "locale": {
        ...
        "time_format": "12h",
        "currency": "USD",
        "number_format": {"grouping": "western"},
    },
    "modules": {
