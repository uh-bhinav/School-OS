// ============================================================================
// FILE: src/app/components/albums/AlbumPhotoUploader.tsx
// PURPOSE: Photo uploader component for albums with drag-and-drop support
// ============================================================================
...
import { useUploadAlbumImages } from "../../services/albums.hooks";
...
export default function AlbumPhotoUploader({
  ...
  const uploadMutation = useUploadAlbumImages();
