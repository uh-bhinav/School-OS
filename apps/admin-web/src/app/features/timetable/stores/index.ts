/**
 * Timetable Generator Stores (ERP Integration)
 *
 * Zustand stores for managing timetable state.
 * Persisted to localStorage with ERP-compatible keys.
 */
...
export const useConstraintsStore = create<ConstraintsState>()(
  persist(
    ...
    {
      name: 'erp-timetable-constraints', // ERP-prefixed key
...
export const useJobStore = create<JobState>()(
  persist(
    ...
    {
      name: 'erp-timetable-current-job', // ERP-prefixed key
      storage: createJSONStorage(() => localStorage),
      partialize: (state) => ({
...
export const useResultStore = create<ResultState>()(
  persist(
    ...
    {
      name: 'erp-timetable-result', // ERP-prefixed key
      storage: createJSONStorage(() => localStorage),
      partialize: (state) => ({
        jobId: state.jobId,
        result: state.result,
